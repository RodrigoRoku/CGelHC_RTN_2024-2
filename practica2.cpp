...
int main()
{
	...
	int opcion = 0; //modificar para renderizar diferentes elementos en pantalla. 
	...
	opcion = 1; //1) Código de prueba dado por el profesor. 2) Código del ejecicio 1  3) código del ejercicio 2
	while (!mainWindow.getShouldClose())
	{
		...
		switch(opcion)
		{
			...
			case 3:
				...
				uniformProjection = shaderList[1].getProjectLocation();
				model = glm::mat4(1.0);
				model = glm::translate(model, glm::vec3(0.0f, -0.5f, -4.0f));//Centro en 0, -0.5, borde izq en x = -0.6, borde der en x = 0.6, borde sup en y = 0.1, borde inf en y = -1.1
				model = glm::scale(model, glm::vec3(0.8f, 1.0f, 0.5f));//Largo = 1.2, ancho = 0.8.
				glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
				glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
				meshColorList[5]->RenderMeshColor();
				...
				model = glm::scale(model, glm::vec3(0.3f, 0.3f, 0.3f)); //longitud_lado = 0.3
				glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
				glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
				meshColorList[6]->RenderMeshColor();
				...
				model = glm::scale(model, glm::vec3(0.2f, 0.3f, 0.5f));//altura = 0.6, base = 0.4
				glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
				glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
				meshColorList[4]->RenderMeshColor();
				...
				model = glm::scale(model, glm::vec3(0.2f, 0.2f, 0.5f));//Longitud = 0.4
				glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
				glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
				meshColorList[7]->RenderMeshColor();
